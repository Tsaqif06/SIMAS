...
class PrestasiGuru_model
{
    ...
    public function getAllPrestasiGuru()
    {
    ...
    public function getPrestasiGuruById($id)
    {
    ...
    public function tambahDataPrestasiGuru($data)
    {
        $query = "INSERT INTO prestasi_guru
                    VALUES
                  (NULL, :uuid, :nama, :prestasi, :skala, :juara, :tahun, '', CURRENT_TIMESTAMP, :created_by, null, '', null, '', null, '', 0, 0, DEFAULT)";
    ...
    public function hapusDataPrestasiGuru($id)
    {
        $this->db->query(
            "UPDATE {$this->table}
            SET
    ...
    public function ubahDataPrestasiGuru($data)
    {
    ...
    public function importData()
    {
        ...
        for ($row = 2; $row <= $highestRow; $row++) {
            ...
            $response = $this->tambahDataPrestasiGuru($data);
        }
        return $response;
    }
}
