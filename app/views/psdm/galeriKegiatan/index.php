    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form enctype="multipart/form-data" action="<?= BASEURL; ?>/galeriKegiatan/tambah" method="post">
        ...
        <?php foreach ($data['galeri'] as $galeri) : ?>
          <div class="slide active">
            ...
            <div class="info">
              ...
              <a href="<?= BASEURL; ?>/galeriKegiatan/ubah/<?= $galeri['id'] ?>" data-bs-toggle="modal" data-bs-target="#exampleModalLong" class="tampilModalUbah" data-id="<?= $galeri['id']; ?>" style="text-align:right; text-decoration: none; color: black;">
                <!-- <button class="button-arounder">  -->
                <span class="material-symbols-outlined"> edit </span>
                <!-- </button> -->
              </a>
              <a href="<?= BASEURL; ?>/galeriKegiatan/hapus/<?= $galeri['id'] ?>" onclick="return confirm ('Hapus data?')" style="text-align:right; text-decoration: none; color: black;">
                <!-- <button class="button-arounder"> -->
    ...
    $(".tampilModalUbah").click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $("#fotoLama").val(data.fotokegiatan);
