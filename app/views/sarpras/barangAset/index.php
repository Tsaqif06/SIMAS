  ...
  <div class="row">
    <div class="col">
      <a class="btn btn-primary " role="button" data-toggle="modal" data-target="#exampleModalLong">Tambah Data Barang
        Aset</a>
      <button type="button" class="btn btn-primary my-3 mx-3 tampilModalImport" data-url="<?= BASEURL ?>/barangAset"
              ...
              <tbody>
                ...
                <?php foreach ($data['barang_aset'] as $aset): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= BASEURL; ?>/barangAset/ubah/<?= $aset['id'] ?>" data-bs-toggle="modal"
                        data-bs-target="#exampleModalLong" class="tampilModalUbah" data-id="<?= $aset['id']; ?>">
                        <button class="button-arounder">
                          <span class="material-symbols-outlined"> edit </span>
                        </button>
                      </a>
                      <a href="<?= BASEURL; ?>/barangAset/hapus/<?= $aset['id'] ?>"
