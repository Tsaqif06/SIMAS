...
<div class="content-wrapper">
  ...
  <div class="col-md-12 grid-margin transparent">
    <div class="row">
      ...
      <a class="spa-load col-md-6 mb-4 stretch-card transparent pengajuan" href="<?= BASEURL; ?>/pengajuanJurusan"
      ...
      <a class="spa-load col-md-6 mb-4 stretch-card transparent" href="<?= BASEURL; ?>/pengajuanMapel"
        style="text-decoration:none;">
        <div class="card card-dark-blue">
          <div class="card-body">
      ...
      <div class="col-md-12 grid-margin transparent">
        <div class="row">
          <a class="spa-load col-md-6 mb-4 stretch-card transparent" href="<?= BASEURL; ?>/pengajuanBidang"
            style="text-decoration: none;">
          ...
          <a class="spa-load col-md-6 mb-4 stretch-card transparent" href="<?= BASEURL; ?>/pengajuanWaka"
            style="text-decoration: none;">
            <div class="card card-tale">
              <div class="card-body">
