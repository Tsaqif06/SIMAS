    ...
    <div class="row mb-4">
        <div class="col">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#exampleModalLong">TAMBAH DATA BARANG MASUK</button>
            <button type="button" class="btn btn-primary my-3 mx-3 tampilModalImport"
                data-url="<?= BASEURL ?>/barangMasuk" data-bs-toggle="modal" data-bs-target="#modalImport">
                        ...
                        <table id="print" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $i++; ?></td>
                                    <td><?= $masuk['tgl'] ?></td>
                                    <td><img src="<?= BASEURL ?>/images/datafoto/<?= $masuk['foto'] ?>"
                                            style="border-radius: 0px; width: 100px; height: auto;"></td>
                                    <td><?= $masuk['uraian'] ?></td>
                                    <td><?= $masuk['jumlah'] ?></td>
                                    <td><?= $masuk['satuan'] ?></td>
                                    <td><?= $masuk['keterangan'] ?></td>
                                    <td>
                                        <a href="<?= BASEURL; ?>/barangMasuk/ubah/<?= $masuk['id'] ?>"
                                            data-bs-toggle="modal" data-bs-target="#exampleModalLong"
                                            class="tampilModalUbah" data-id="<?= $masuk['id']; ?>">
                                            <button class="button-arounder">
                                                <span class="material-symbols-outlined"> edit </span>
                                            </button>
                                        </a>
                                        <a href="<?= BASEURL; ?>/barangMasuk/hapus/<?= $masuk['id'] ?>"
