    ...
    <div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL ?>/peminjamanBarang/importData" method="post"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="badge badge-warning fw-bold mx-auto"
                                            href="<?= BASEURL; ?>/peminjamanBarang/ubahStatusPinjam/1/<?= $peminjaman['id'] ?>"
                                            onclick="return confirm(`Ubah status menjadi 'dipinjam'?`)">Diajukan</a>
                                        <?php elseif ($peminjaman['statuspinjam'] == 1) : ?>
                                        <a class="badge badge-success fw-bold mx-auto"
                                            href="<?= BASEURL; ?>/peminjamanBarang/ubahStatusPinjam/2/<?= $peminjaman['id'] ?>"
                                            onclick="return confirm(`Ubah status menjadi 'dikembalikan'?`)">Dipinjam</a>
                                        <?php else : ?>
                                        <a class="badge badge-secondary fw-bold mx-auto"
                                            href="<?= BASEURL; ?>/peminjamanBarang/ubahStatusPinjam/0/<?= $peminjaman['id'] ?>"
                                            onclick="return confirm(`Ubah status menjadi semula? ('dipinjam')`)">Dikembalikan</a>
                                        <?php endif ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="<?= BASEURL; ?>/peminjamanBarang/ubah/<?= $peminjaman['id'] ?>"
                                            data-bs-toggle="modal" data-bs-target="#exampleModalLong"
                                            class="tampilModalUbah" data-id="<?= $peminjaman['id']; ?>">
