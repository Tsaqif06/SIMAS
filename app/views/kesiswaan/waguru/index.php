<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-lg-6">
      <button type="button" class="btn btn-primary my-3 tampilModalTambah" data-url="<?= BASEURL ?>/waguru/tambahData"
                  ...
                  <tr>
                    ...
                    <td class="font-weight-medium">
                      <a href="" class="tampilModalUbah" style="cursor: pointer;"
                        data-url="<?= BASEURL ?>/waguru/ubahData" data-bs-toggle="modal" data-bs-target="#modal"
                        data-id="<?= $row['id'] ?>">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= BASEURL ?>/waguru/importData" method="post" enctype="multipart/form-data">
            <div class="mb-3">
