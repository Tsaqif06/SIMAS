<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-lg-6">
        <button type="button" class="btn btn-primary my-3 tampilModalTambah" data-url="<?= BASEURL ?>/infokesiswaan/tambahData" data-bs-toggle="modal" data-bs-target="#modal">
                  ...
                  <?php foreach ($data['infokesiswaan'] as $row) : ?>
                    <tr>
                      ...
                      <td class="font-weight-medium">
                        <a href="" class="badge text-bg-success tampilModalUbah" style="cursor: pointer;" data-url="<?= BASEURL ?>/infoesisinfokesiswaan/ubahData" data-bs-toggle="modal" data-bs-target="#modal" data-id="<?= $row['id'] ?>">
