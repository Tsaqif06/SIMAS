    ...
    <div class="row">
        <div class="col-lg-6">
            <button type="button" class="btn btn-primary my-3 tampilModalTambah"
                data-url="<?= BASEURL ?>/kehadiran/tambahData" data-bs-toggle="modal" data-bs-target="#modal">
                Tambah Data Absen
            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-medium">
                                            <a href="" class="tampilModalUbah" style="cursor: pointer;"
                                                data-url="<?= BASEURL ?>/kehadiran/ubahData" data-bs-toggle="modal"
                                        ...
                                        <td><button type="button"
                                                class="btn btn-<?= $row['bs-class'] ?> btn-rounded btn-fw"><?= $row['keterangan'] ?></button>
                                        </td>
