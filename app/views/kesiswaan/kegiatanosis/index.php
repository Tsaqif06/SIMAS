<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-lg-6">
        <button type="button" class="btn btn-primary my-3 tampilModalTambah" data-url="<?= BASEURL ?>/dkegiatanosis/tambahData" data-bs-toggle="modal" data-bs-target="#modal">
          Tambah Data Kegiatan OSIS
        </button>
      </div>
    </div>
                  ...
                  <?php foreach ($data['kegiatanosis'] as $row) : ?>
                    <tr>
                      ...
                      <td class="font-weight-medium">
                        <a href="" class="badge text-bg-success tampilModalUbah" style="cursor: pointer;" data-url="<?= BASEURL ?>/kegiatanosis/ubahData" data-bs-toggle="modal" data-bs-target="#modal" data-id="<?= $row['id'] ?>">
                          <i class="ti ti-pencil"></i>
                        </a>
                        <a href="<?= BASEURL ?>/kegiatanosis/hapusData/<?= $row['id'] ?>">
