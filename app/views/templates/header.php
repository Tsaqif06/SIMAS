                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="masterdata">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL ?>/walikelas">Wali Kelas</a>
                                    </li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL ?>/mapel">Mata Pelajaran</a>
                                    </li>
                        ...
                        <div class="collapse" id="kesiswaan">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <ul style="list-style-type: none;">
                                    ...
                                    <li><a class="navsubitem" href="<?= BASEURL ?>/kompkeahlian">Kompetensi Keahlian</a>
                                    </li>
                                    <li><a class="navsubitem" href="<?= BASEURL ?>/progkeahlian">Program Keahlian</a>
                                    </li>
                                ...
                                <ul style="list-style-type: none;">
                                    ...
                                    <li><a class="navsubitem" href="<?= BASEURL ?>/kecelakaan">Asuransi Kecelakaan</a>
                                    </li>
