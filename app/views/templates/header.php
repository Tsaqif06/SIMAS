                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="masterdata">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL ?>/mapel">Mata Pelajaran</a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="tu">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL ?>/nopetunjuk">Nomor Petunjuk</a></li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="collapse" id="pkl">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <ul style="list-style-type: none;">
                                        ...
                                        <li><a class="navsubitem text-white" href="<?= BASEURL; ?>/pkl/dtampung">Daya Tampung</a></li>
                                        <?php endif ?>
                                        ...
                                        <li><a class="navsubitem text-white" href="<?= BASEURL; ?>/pkl/nilai">Nilai PKL</a></li>
                                        <?php endif ?>
                                    </ul>
                                    ...
                                    <ul style="list-style-type: none;">
                                        ...
                                        <li><a class="navsubitem text-white" href="<?= BASEURL; ?>/bkk/lomba">Lomba</a></li>
                                        <?php endif ?>

                                        <?php if ($data['user']['hak_akses'] == 'industri') : ?>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL; ?>/bkk/loker">Lowongan Kerja</a></li>
                                        <?php endif ?>
                            ...
                            <div class="collapse" id="kesiswaan">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <ul style="list-style-type: none;">
                                        ...
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/kompkeahlian">Kompetensi Keahlian</a></li>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/progkeahlian">Program Keahlian</a></li>
                                    ...
                                    <ul style="list-style-type: none;">
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/asuransi">Asuransi</a></li>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/kecelakaan">Asuransi Kecelakaan</a></li>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/ortumeninggal">Asuransi Ortu Meninggal</a></li>
                                    </ul>
                                    <li class="nav-item">
                                        <a class="nav-link">Informasi</a>
                                    </li>
                                    <ul style="list-style-type: none;">
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/infokesiswaan">Informasi Kesiswaan</a></li>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/kegiatanosis">Kegiatan Osis</a></li>
                                    </ul>
                                    <ul style="list-style-type: none;">
                                        <li><a class="navsubitem text-white" href="<?= BASEURL ?>/waguru">Whatsapp Guru</a></li>
                                    </ul>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="kurikulum">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/GKP">Gelar Karya<br>Pembelajaran </a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/Rapor">Rapor </a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/DaftarHadir">Daftar Hadir Siswa </a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/walikelas">Wali Kelas </a></li>
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/KegiatanGLS">Gerakan Literasi<br>Sekolah</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/Inbis">Inkubator Bisnis </a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/LMS">Learning Manajemen<br>System </a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?= BASEURL; ?>/Penilaian">Penilaian</a></li>
                                </ul>
                            </div>
                        </li>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="charts">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link spa-load" href="<?= BASEURL; ?>/profilPegawai">Profil Pegawai</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link spa-load" href="<?= BASEURL; ?>/strukturOrganisasi">Struktur Organisasi</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link spa-load" href="<?= BASEURL; ?>/prestasiGuru">Prestasi Guru</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link spa-load" href="<?= BASEURL; ?>/galeriKegiatan">Galeri Kegiatan</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="tables">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <?php if ($data['user']['role'] == 'admin' && ($data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == 'sarpras')) : ?>
                                    <li class="nav-item"> <a class="nav-link spa-load"
                                            href="<?= BASEURL; ?>/barangMasuk">Barang Masuk</a></li>
                                    <li class="nav-item"> <a class="nav-link spa-load"
                                            href="<?= BASEURL; ?>/barangKeluar">Barang Keluar</a></li>
                                    <li class="nav-item"><a class="nav-link spa-load"
                                            href="<?= BASEURL; ?>/barangAset">Stok Barang Aset</a></li>
                                    <li class="nav-item"><a class="nav-link spa-load"
                                            href="<?= BASEURL; ?>/stokBarang">Stok Barang</a></li>
                                    <li class="nav-item"><a class="nav-link spa-load"
                                            href="<?= BASEURL; ?>/dataRuang">Data Ruang</a></li>
                                    <li class="nav-item"><a class="nav-link spa-load"
