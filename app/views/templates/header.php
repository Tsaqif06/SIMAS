...
<head>
    ...
    .card.card-tale {
        background: linear-gradient(150deg, #39ef74, #4600f1 100%) !important;
        color: #ffffff !important;
    }

    .card-tale:hover,
    .card-tale:focus {
        background: linear-gradient(170deg, #39ef74, #4600f1 100%) !important;
    }
    ...
    .card-dark-blue:focus {
        background: linear-gradient(360deg, #f731db, #4600f1 100%) !important;
    }

    .card.card-light-blue {
        background: linear-gradient(to left, #80ffdb, #5390d9) !important;
        color: #ffffff !important;
    }

    .card.card-light-blue:hover,
    .card-light-blue:focus {
        background: linear-gradient(to right, #80ffdb, #5390d9) !important;
    }
    </style>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?= BASEURL; ?>/images/logodoang.png" />
</head>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                            ...
                            <div class="collapse" id="pkl">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <ul style="list-style-type: none;">
                                        <?php if (($data['user']['role'] == 'admin' && ($data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == 'humas')) || $data['user']['role'] == 'guru' || $data['user']['hak_akses'] == 'kabeng') : ?>
                                        ...
                                        <?php if ($data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == '' || $data['user']['hak_akses'] == 'kabeng' || $data['user']['hak_akses'] == 'humas' || $data['user']['role'] == 'guru') : ?>
                                        <li><a class="navsubitem text-white"
                                                href="<?= BASEURL; ?>/pkl/pemberkasan">Pemberkasan</a></li>
                                        <?php endif ?>

                                        <?php if ($data['user']['role'] == 'admin' || $data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == 'industri' || $data['user']['role'] == 'guru' || $data['user']['hak_akses'] == 'kabeng') : ?>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL; ?>/pkl/nilai">Nilai
                                                PKL</a></li>
                                        <?php endif ?>
                                    </ul>

                                    <?php if (($data['user']['role'] == 'admin' || $data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == '' || $data['user']['hak_akses'] == 'humas' || $data['user']['hak_akses'] == 'industri') || $data['user']['role'] == 'siswa' || $data['user']['role'] == 'guru'  || $data['user']['hak_akses'] == 'kabeng') : ?>
                                    <li class="nav-item">
                                    ...
                                    <ul style="list-style-type: none;">
                                        ...
                                        <?php if ($data['user']['role'] == 'admin' || $data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == 'industri' || $data['user']['hak_akses'] == 'humas' || $data['user']['role'] == 'guru' || $data['user']['hak_akses'] == 'kabeng') : ?>
                                        <li><a class="navsubitem text-white" href="<?= BASEURL; ?>/bkk/loker">Lowongan
                                                Kerja</a></li>
                                        <?php endif ?>

                                        <?php if ($data['user']['hak_akses'] == 'all' || $data['user']['hak_akses'] == '' || $data['user']['hak_akses'] == 'humas' || $data['user']['role'] == 'guru' || $data['user']['hak_akses'] == 'kabeng') : ?>
                                        <li><a class="navsubitem text-white"
                        ...
                        <?php if ($data['user']['role'] == 'admin' || $data['user']['hak_akses'] == '' || $data['user']['hak_akses'] == 'industri' || $data['user']['hak_akses'] == 'sarpras' || $data['user']['hak_akses'] == 'kabeng') : ?>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="tables">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <?php if ($data['user']['role'] == 'guru' || $data['user']['hak_akses'] == 'kabeng') : ?>
                                    <li class="nav-item"> <a class="nav-link"
