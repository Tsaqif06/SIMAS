...
<body>
    ...
    <div class="main">
        <div class="container-scroller">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#humas" aria-expanded="false" aria-controls="form-elements">
                ...
                <div class="collapse" id="humas">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <div class="collapse" id="sub-humas">
                            <div class="navsubitem" id="pkl">
