            ...
            <table id="tablepemberkasan" class="table table-hover table-main">
              ...
              <tbody>
                ...
                <?php foreach ($data['siswa'] as $row) : ?>
                  <td>
                    <?php if ($row['status_penempatan'] == 0) : ?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLabel">Detail Penempatan</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
          <input type="hidden" id="id">
          <input type="hidden" id="nis">
          <input type="hidden" id="nisn">
          <input type="hidden" id="namasiswa">
          <input type="hidden" id="kelassiswa">
          <input type="hidden" id="jurusansiswa">
            ...
            <div class="col-md-12">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tempatperusahaan" placeholder="Kota" readonly>
                </div>
                <div class="form-group">
                  <label for="namaperusahaan">Penempatan Industri</label>
                  <input type="text" class="form-control" id="namaperusahaan" placeholder="Nama Perusahaan" readonly>
                </div>
              </div>
            </div>
          </div>
