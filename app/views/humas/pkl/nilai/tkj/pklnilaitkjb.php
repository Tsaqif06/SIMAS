            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Data Nilai PKL Tekhnik Komputer Jaringan</h3>
                  <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASEURL; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASEURL; ?>/pkl/nilai"> Data Nilai </a> | <span class="text-primary"> Tekhnik Komputer Jaringan </span></h6>
                </div>
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="tablenilaitkj">  
                  <thead>
                    <tr>
                        <th>Aksi</th>
                        <th>NISN</th>
