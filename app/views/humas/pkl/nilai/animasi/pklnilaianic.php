    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/pkl/importDataanic" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= BASEURL; ?>/PKL/tambahDataNilaiANIC" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="XI ANI C" class="form-control" id="kelas" name="kelas" readonly>
                </div>
                <div class="form-group">
              ...
              <table class="table table-hover" id="table">
                ...
                <tbody>
                  <?php foreach ($data['ndga'] as $ppdga) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASEURL; ?>/PKL/ubahDataNilaiANIC/<?= $ppdga['id']; ?>" class="nanic" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a href="<?= BASEURL; ?>/PKL/hapusDataNilaiANIC/<?= $ppdga['id']; ?>" onclick="return confirm('Apakah anda sudah yakin?');">
...
<script>
  $(function() {
    ...
    $(".nanic").click(function() {
      $("#modal").addClass("edit");
      $("#modalLabel").html("Ubah Data Industri");
      $(".modal-footer button[type=submit]").html("Ubah Data");
      $(".modal-body form").attr("action", `http://localhost/SIMAS/public/pkl/ubahDataNilaiANIC`);

      const id = $(this).data("id");
      console.log(id);

      $.ajax({
        url: `http://localhost/SIMAS/public/pkl/getUbahNilaiANIC`,
        data: {
          id: id
        },
        method: "post",
