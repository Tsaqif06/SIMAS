              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataNilaiANIC" method="post">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="myTable">  
                  ...
                  <?php foreach ( $data['ndga'] as $ppdga ) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASESDATAS; ?>/PKL/ubahDataNilaiANIC/<?= $ppdga['id'];?>" class="nanic" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a  href="<?= BASESDATAS; ?>/PKL/hapusDataNilaiANIC/<?= $ppdga['id'];?>" onclick="return confirm('Apakah anda sudah yakin?');">
  ...
  <script>
    ...
    $(".nanic").click(function () {
				...
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataNilaiANIC`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahNilaiANIC`,
					data: { id: id },
					method: "post",
					dataType: "json",
