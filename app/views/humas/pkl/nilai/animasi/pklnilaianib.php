            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASESDATAS; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASESDATAS; ?>/pkl/nilai"> Nilai </a> | <span class="text-primary"> Animasi </span></h6>
                </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="justify-content-end d-flex">
                     <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                       ...
                       <a class="dropdown-item" href="<?= BASESDATAS; ?>/pkl/nilaiania">ANI A</a>
                         <a class="dropdown-item" href="<?= BASESDATAS; ?>/pkl/nilaianib">ANI B</a>
                         <a class="dropdown-item" href="<?= BASESDATAS; ?>/pkl/nilaianic">ANI C</a>
                       </div>
                     </div>
                    </div>
                   </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataNilaiANIB" method="post">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="myTable">  
                  ...
                  <?php foreach ( $data['ndga'] as $ppdga ) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASESDATAS; ?>/PKL/ubahDataNilaiANIB/<?= $ppdga['id'];?>" class="nanib" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a  href="<?= BASESDATAS; ?>/PKL/hapusDataNilaiANIB/<?= $ppdga['id'];?>" onclick="return confirm('Apakah anda sudah yakin?');">
  ...
  <script>
    ...
    $(".nanib").click(function () {
				...
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataNilaiANIB`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahNilaiANIB`,
					data: { id: id },
					method: "post",
					dataType: "json",
