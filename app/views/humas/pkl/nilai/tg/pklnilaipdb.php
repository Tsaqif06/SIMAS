            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Data Nilai PKL Tekhnik Grafika</h3>
                  <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASEURL; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASEURL; ?>/pkl/nilai"> Data Nilai </a> | <span class="text-primary"> Tekhnik Grafika </span></h6>
                </div>
        ...
        <div class="row">
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="ketnilai">
                            <option>Lulus</option>
          ...
          <div class="row">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="tablenilaitg">  
                  <thead>
                    <tr>
                      <th>Aksi</th>
                      <th>NISN</th>
