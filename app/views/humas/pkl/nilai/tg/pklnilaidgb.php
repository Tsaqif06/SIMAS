            ...
            <div class="justify-content-end d-flex">
              <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaidga">DG A</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaidgb">DG B</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaidgc">DG C</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaidgd">DG D</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaipda">PD A</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaipdb">PD B</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaipdc">PD C</a>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/pkl/nilaipdd">PD D</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/pkl/importDatadgb" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= BASEURL; ?>/PKL/tambahDataNilaiDGB" method="post">
              ...
              <table class="table table-hover" id="table">
                ...
                <tbody>
                  <?php foreach ($data['ndga'] as $ppdga) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASEURL; ?>/PKL/ubahDataNilaiDGB/<?= $ppdga['id']; ?>" class="ndgb" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a href="<?= BASEURL; ?>/PKL/hapusDataNilaiDGB/<?= $ppdga['id']; ?>" onclick="return confirm('Apakah anda sudah yakin?');">
...
<script>
  $(function() {
    ...
    $(".ndgb").click(function() {
      ...
      $(".modal-body form").attr("action", `http://localhost/SIMAS/public/pkl/ubahDataNilaiDGB`);

      const id = $(this).data("id");
      console.log(id);

      $.ajax({
        url: `http://localhost/SIMAS/public/pkl/getUbahNilaiDGB`,
        data: {
          id: id
        },
        method: "post",
