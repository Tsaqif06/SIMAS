    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/pkl/importDatapdd" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= BASEURL; ?>/PKL/tambahDataNilaiPDD" method="post">
              ...
              <table class="table table-hover" id="table">
                ...
                <tbody>
                  <?php foreach ($data['ndga'] as $ppdga) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASEURL; ?>/PKL/ubahDataNilaiPDD/<?= $ppdga['id']; ?>" class="npdd" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a href="<?= BASEURL; ?>/PKL/hapusDataNilaiPDD/<?= $ppdga['id']; ?>" onclick="return confirm('Apakah anda sudah yakin?');">
...
<script>
  $(function() {
    ...
    $(".npdd").click(function() {
      ...
      $(".modal-body form").attr("action", `http://localhost/SIMAS/public/pkl/ubahDataNilaiPDD`);

      const id = $(this).data("id");
      console.log(id);

      $.ajax({
        url: `http://localhost/SIMAS/public/pkl/getUbahNilaiPDD`,
        data: {
          id: id
        },
        method: "post",
