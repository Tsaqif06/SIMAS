      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            <h3 class="font-weight-bold">Data Nilai PKL Mekatronika</h3>
            <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASEURL; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASEURL; ?>/pkl/nilai"> Data Nilai </a> | <span class="text-primary"> Mekatronika </span></h6>
          </div>
            ...
            <div class="modal-body">
              <form>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="perusahaan">
                </div>
                <div class="form-group">
