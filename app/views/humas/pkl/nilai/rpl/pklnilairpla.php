              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataNilaiRPLA" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="XI RPL A" class="form-control" id="kelas" name="kelas" readonly>
                      </div>
                      <div class="form-group">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="myTable">  
                  ...
                  <?php foreach ( $data['ndga'] as $ppdga ) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASESDATAS; ?>/PKL/ubahDataNilaiRPLA/<?= $ppdga['id'];?>" class="nrpla" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a  href="<?= BASESDATAS; ?>/PKL/hapusDataNilaiRPLA/<?= $ppdga['id'];?>" onclick="return confirm('Apakah anda sudah yakin?');">
  ...
  <script>
    ...
    $(".nrpla").click(function () {
				$("#modal").addClass("edit");
				$("#modalLabel").html("Ubah Data Industri");
				$(".modal-footer button[type=submit]").html("Ubah Data");
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataNilaiRPA`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahNilaiRPLA`,
					data: { id: id },
					method: "post",
					dataType: "json",
