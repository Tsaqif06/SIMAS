            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASEURL; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASEURL; ?>/pkl/rekap"> Rekapitulasi </a> | <span class="text-primary"> Perpanjang Masa PKL </span></h6>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-md-12 grid-margin">
        <div class="template-demo">
          <button type="button" class="btn btn-primary tomboltambahdata7" data-toggle="modal"
                ...
                foreach ($data['pp'] as $pp) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="badge badge-success tampildataubah7"
                        data-url="<?= BASEURL ?>/PKL/ubahDTAPP/<?= $pp['id']; ?>" data-toggle="modal"
                        data-target="#formmodal" data-id="<?= $pp['id'] ?>"><i class="mdi mdi-pencil"></i></a>

                      <a href="<?= BASEURL; ?>/pkl/HapusDataPP/<?= $pp['id']; ?>" class="badge badge-danger"
