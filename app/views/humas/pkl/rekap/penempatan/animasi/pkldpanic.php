                ...
                <div class="col-12 col-xl-4">
                    <div class="justify-content-end d-flex">
                     <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                       ...
                       <a class="dropdown-item" href="<?= BASESDATAS; ?>/pkl/penempatanania">ANI A</a>
                         <a class="dropdown-item" href="<?= BASESDATAS; ?>/pkl/penempatananib">ANI B</a>
                         <a class="dropdown-item" href="<?= BASESDATAS; ?>/pkl/penempatananic">ANI C</a>
                       </div>
                     </div>
                    </div>
                   </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataPenempatananic" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="XI ANIMASI C" class="form-control" id="kelassiswa" name="kelassiswa" readonly>
                      </div>
                      <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="myTable">  
                  ...
                  <tbody>
                  <?php foreach ( $data['ppanic'] as $ppdga ) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASESDATAS; ?>/PKL/ubahDataPenempatanANIC/<?= $ppdga['id'];?>" class="ppanic" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a  href="<?= BASESDATAS; ?>/PKL/hapusDataPenempatanANIC/<?= $ppdga['id'];?>" onclick="return confirm('Apakah anda sudah yakin?');">
  ...
  <script>
    ...
    $(".ppanic").click(function () {
				...
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataPenempatanANIC`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahPenempatanANIC`,
					data: { id: id },
					method: "post",
					dataType: "json",
