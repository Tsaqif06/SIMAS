...
a:hover{
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASESDATAS; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASESDATAS; ?>/pkl/rekap"> Rekapitulasi </a> | <a class="text-dark" href="<?= BASESDATAS; ?>/pkl/penempatan"> Data Penempatan </a> | <span class="text-primary"> Teknik Grafika </span></h6>
                </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataPenempatanDGA" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="XI DG A" class="form-control" id="kelassiswa" name="kelassiswa" readonly>
                      </div>
                      <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="myTable">  
                ...
                <tbody>
                  <?php foreach ( $data['ppdga'] as $ppdga ) : ?>
                  <tr>
                    <td>
                      <a href="<?= BASESDATAS; ?>/PKL/ubahDataPenempatanDGA/<?= $ppdga['id'];?>" class="ppdga" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                        <label class="badge badge-success">
                          <i class="mdi mdi-lead-pencil"></i>
                        </label>
                      </a>
                      <a  href="<?= BASESDATAS; ?>/PKL/hapusDataPenempatanDGA/<?= $ppdga['id'];?>" onclick="return confirm('Apakah anda sudah yakin?');">
  ...
  <script>
    ...
    $(".ppdga").click(function () {
				$("#modal").addClass("edit");
				$("#modalLabel").html("Ubah Data Industri");
				$(".modal-footer button[type=submit]").html("Ubah Data");
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataPenempatanDGA`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahPenempatanDGA`,
					data: { id: id },
					method: "post",
					dataType: "json",
