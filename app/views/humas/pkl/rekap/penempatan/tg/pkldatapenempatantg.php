    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/pkl/importDataPNDGA" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= BASEURL; ?>/PKL/tambahDataPenempatanDGA" method="post">
              ...
              <table class="table table-hover" id="table">
                ...
                <tbody>
                  <?php foreach ($data['ppdga'] as $ppdga) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASEURL; ?>/PKL/ubahDataPenempatanDGA/<?= $ppdga['id']; ?>" class="ppdga" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a href="<?= BASEURL; ?>/PKL/hapusDataPenempatanDGA/<?= $ppdga['id']; ?>" onclick="return confirm('Apakah anda sudah yakin?');">
...
<script>
  $(function() {
    ...
    $(".ppdga").click(function() {
      ...
      $(".modal-body form").attr("action", `http://localhost/SIMAS/public/pkl/ubahDataPenempatanDGA`);

      const id = $(this).data("id");
      console.log(id);

      $.ajax({
        url: `http://localhost/SIMAS/public/pkl/getUbahPenempatanDGA`,
        data: {
          id: id
        },
        method: "post",
