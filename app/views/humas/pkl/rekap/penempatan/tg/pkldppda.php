              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataPenempatanpda" method="post">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="tabledptg">  
                  ...
                  <?php foreach ( $data['pppda'] as $ppdga ) : ?>
                    <tr>
                      <td>
                        <a href="<?= BASESDATAS; ?>/PKL/ubahDTAIZ/<?= $ppdga['id'];?>" class="pppda" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
  ...
  <script>
    ...
    $(".pppda").click(function () {
				...
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataPenempatanPDA`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahPenempatanPDA`,
					data: { id: id },
					method: "post",
					dataType: "json",
