              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= BASESDATAS; ?>/PKL/tambahDataPenempatanpdb" method="post">
            ...
            <div class="table-responsive ">
              <table class="table table-hover" id="tabledptg">  
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <a href="<?= BASESDATAS; ?>/PKL/ubahDataPenempatanPDB/<?= $ppdga['id'];?>" class="pppdb" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                          <label class="badge badge-success">
                            <i class="mdi mdi-lead-pencil"></i>
                          </label>
                        </a>
                        <a  href="<?= BASESDATAS; ?>/PKL/hapusDataPenempatanPDB/<?= $ppdga['id'];?>" onclick="return confirm('Apakah anda sudah yakin?');">
  ...
  <script>
    ...
    $(".pppdb").click(function () {
				...
				$(".modal-body form").attr("action", `http://localhost/simashumaspkl/public/pkl/ubahDataPenempatanPDB`);

				const id = $(this).data("id");
        console.log(id);

				$.ajax({
					url: `http://localhost/simashumaspkl/public/pkl/getUbahPenempatanPDB`,
					data: { id: id },
					method: "post",
					dataType: "json",
