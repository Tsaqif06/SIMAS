    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/pkl/importDataPNPDB" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= BASEURL; ?>/PKL/tambahDataPenempatanpdb" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="XI PD B" class="form-control" id="kelassiswa" name="kelassiswa" readonly>
                </div>
                <div class="form-group">
          ...
          <div class="card-body">
            <div class="table-responsive ">
              <table class="table table-hover" id="tabledptg">
                ...
                <tbody>
                  <tr>
                    <?php foreach ($data['pppdb'] as $ppdga) : ?>
                  <tr>
                    <td>
                      <a href="<?= BASEURL; ?>/PKL/ubahDataPenempatanPDB/<?= $ppdga['id']; ?>" class="pppdb" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=<?= $ppdga['id']; ?>>
                        <label class="badge badge-success">
                          <i class="mdi mdi-lead-pencil"></i>
                        </label>
                      </a>
                      <a href="<?= BASEURL; ?>/PKL/hapusDataPenempatanPDB/<?= $ppdga['id']; ?>" onclick="return confirm('Apakah anda sudah yakin?');">
...
<script>
  $(function() {
    ...
    $(".pppdb").click(function() {
      $("#modal").addClass("edit");
      $("#modalLabel").html("Ubah Data Industri");
      $(".modal-footer button[type=submit]").html("Ubah Data");
      $(".modal-body form").attr("action", `http://localhost/SIMAS/public/pkl/ubahDataPenempatanPDB`);

      const id = $(this).data("id");
      console.log(id);

      $.ajax({
        url: `http://localhost/SIMAS/public/pkl/getUbahPenempatanPDB`,
        data: {
          id: id
        },
        method: "post",
