      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            ...
            <h6 class="font-weight-normal mb-0"><a class="text-dark" href="<?= BASEURL; ?>/pkl"> Laman PKL</a> | <a class="text-dark" href="<?= BASEURL; ?>/pkl/prakerin"> Prakerin </a> | <span class="text-primary"> Monitoring </span></h6>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="modal-body">
              <form action="<?= BASEURL; ?>/PKL/tambahdataMonitoring" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="tanggal_monitoringpkl" name="tanggal_monitoringpkl">
                </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="mt-3">
                        ...
                        <a class="badge badge-success tampildataubah3" data-url="<?= BASEURL ?>/PKL/ubahDTAMonitoring/<?= $mp['id']; ?>" data-toggle="modal" data-target="#formmodal" data-id="<?= $mp['id'] ?>">Edit</a>
                        <div class="mt-3">
