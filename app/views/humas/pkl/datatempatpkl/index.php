            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= BASEURL; ?>/PKL/tambahdatatempat" method="post">
                        ...
                        <div class="form-group">
                            <label for="jurusansiswa">Jurusan Siswa</label>
                            <input type="text" class="form-control" id="jurusansiswa" name="jurusansiswa">
                        </div>
                        <div class="form-group">
                            <label for="tempatperusahaan">Tempat Perusahaan</label>
