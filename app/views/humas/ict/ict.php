      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">ICT - Information and Communication Technology </h3>
                  <h6 class="font-weight-normal mb-0"> Laman ICT Humas | <span class="text-primary">SIMAS</span></h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
			...
			<i class="fa fa-code fa-2x text-black"></i>
                    <div class="col-12">
