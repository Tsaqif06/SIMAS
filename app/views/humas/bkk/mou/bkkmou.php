        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="template-demo">
                    <button type="button" class="btn btn-primary tombolTambahDataMou" data-toggle="modal"
              ...
              foreach ($data['siswa'] as $siswa): ?>
                                    <tr>
                                        <td>
                                            ...
                                            <a class="badge badge-success tampilModalEditdas"
                                                data-url="<?= BASEURL; ?>/bkk/ubahmou/<?= $siswa['id']; ?>"
                                                data-toggle="modal" data-target="#formModal"
                                                data-id="<?= $siswa['id']; ?>"><i class="mdi mdi-lead-pencil"></i></a>
                                            <a href="<?= BASEURL; ?>/bkk/hapusmou/<?= $siswa['id']; ?>"
            ...
            <div class="modal-body">
                <form action="<?= BASEURL; ?>/bkk/tambahmou" class="forms-sample" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bidangkerjadudika" name="bidangkerjadudika"
                            placeholder="Bidang Kerja Dudika">
                    </div>
                    <div class="form-group">
