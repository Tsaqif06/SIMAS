        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="template-demo">
                    <button type="button" class="btn btn-primary tombolTambahDataLoker" data-toggle="modal" data-target="#formModal">Tambah Data</button>
                                    ...
                                    foreach ($data['siswa'] as $siswa) : ?>
                                        <tr>
                                            <td>
                                                ...
                                                <a data-url="<?= BASEURL; ?>/bkk/ubahloker/<?= $siswa['id']; ?>" class="badge badge-success tampilModalEditLoker" data-toggle="modal" data-target="#formModal" data-id="<?= $siswa['id']; ?>"><i class="mdi mdi-lead-pencil"></i></a>
                                                <a href="<?= BASEURL; ?>/bkk/hapusloker/<?= $siswa['id']; ?>" class="badge badge-danger" style="text-decoration: none;"><i class="mdi mdi-delete"></i></a>
                                            </td>
                                            <td><?= $no++; ?></td>
                                            ...
                                            <td><img src="<?= BASEURL; ?>/images/humas/bkk/loker/<?= $siswa['upfotoloker']; ?>" alt="no img" style="width: 65px; height: 65px;"></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
    ...
    <div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="judulModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL; ?>/bkk/tambahloker" method="post" class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" aria-label="Default select example" id="untukjurusan" name="untukjurusan">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="profesiygdibutuhkan" name="profesiygdibutuhkan" placeholder="Profesi yang dibutuhkan">
                        </div>
                        <div class="form-group">
                            <label for="kriteriaprofesi">Kriteria profesi</label>
                            <input type="text" class="form-control" id="kriteriaprofesi" name="kriteriaprofesi" placeholder="Masukkan kriteria">
                        </div>
                        <div class="form-group">
                            <label for="kontakperusahaan">Kontak Perusahaan</label>
                            <input type="text" class="form-control" id="kontakperusahaan" name="kontakperusahaan" placeholder="Kontak">
                        </div>
                        <div class="form-group">
                            <label>Unggah Loker</label>
                            <input type="file" class="file-upload-default" name="upfotoloker" id="upfotoloker">
                            <div class="input-group col-xs-12">
                                <input type="text" class="form-control file-upload-info" disabled placeholder="Unggah Loker">
