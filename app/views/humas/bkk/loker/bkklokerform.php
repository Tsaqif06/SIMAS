...
<div class="content-wrapper">
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Upload Loker</h4>
                <form class="forms-sample">
                    ...
                    <div class="form-group">
                        <label for="profesi">Profesi yang dibutuhkan</label>
                        <input type="text" class="form-control" id="profesi" placeholder="Profesi yang dibutuhkan">
                    </div>
                    <div class="form-group">
