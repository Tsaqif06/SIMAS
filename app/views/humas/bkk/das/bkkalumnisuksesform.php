      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Form Alumni</h4>
                <form class="forms-sample">
                  ...
                  <div class="form-group">
                    <label for="domisili">Jurusan</label>
                    <input type="text" class="form-control" id="jurusan" placeholder="Jurusan">
                  </div>
                  <div class="form-group">
                    <label for="notelp">No. Telp.</label>
                    <input type="number" class="form-control" id="notelp" placeholder="No. Telp.">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jabatan" placeholder="Jabatan saat ini">
                  </div>
                  <div class="form-group">
                    <label>Foto terbaru</label>
                    <input type="file" class="file-upload-default">
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control file-upload-info" disabled placeholder="Unggah Foto terbaru">
