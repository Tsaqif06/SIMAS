                                    ...
                                    <?php foreach ($data['kompkeahlian'] as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="font-weight-medium">
                                                <a href="" class="badge text-bg-success tampilModalUbah" style="cursor: pointer;" data-url="<?= BASEURL ?>kompkeahlian/ubahData" data-bs-toggle="modal" data-bs-target="#modal" data-id="<?= $row['id_kompkeahlian'] ?>">
                                                    <i class="ti ti-pencil"></i>
                                                </a>
                                                <a href="<?= BASEURL ?>kompkeahlian/hapusData/<?= $row['id_kompkeahlian'] ?>">
