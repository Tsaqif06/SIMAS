    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-6">
                <button type="button" class="btn btn-primary my-3 tampilModalTambah" data-url="<?= BASEURL ?>/kompkeahlian/tambahData" data-bs-toggle="modal" data-bs-target="#modal">
                                    ...
                                    <?php foreach ($data['kompkeahlian'] as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="font-weight-medium">
                                                <a href="" class="badge text-bg-success tampilModalUbah" style="cursor: pointer;" data-url="<?= BASEURL ?>/kompkeahlian/ubahData" data-bs-toggle="modal" data-bs-target="#modal" data-id="<?= $row['id'] ?>">
                                                    <i class="ti ti-pencil"></i>
                                                </a>
                                                <a href="<?= BASEURL ?>/kompkeahlian/hapusData/<?= $row['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= BASEURL ?>/kompkeahlian/importData" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
