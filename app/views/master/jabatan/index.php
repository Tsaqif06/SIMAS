    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-6">
                <button type="button" class="btn btn-primary my-3 tampilModalTambah" data-url="<?= BASEURL ?>/jabatan/tambahData" data-bs-toggle="modal" data-bs-target="#modal">
                    Tambah Data Jabatan
                </button>
                                    ...
                                    <?php foreach ($data['jabatan'] as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="font-weight-medium">
                                                <a href="" class="badge text-bg-success tampilModalUbah" style="cursor: pointer;" data-url="<?= BASEURL ?>/jabatan/ubahData" data-bs-toggle="modal" data-bs-target="#modal" data-id="<?= $row['id'] ?>">
                                                    <i class="ti ti-pencil"></i>
                                                </a>
                                                <a href="<?= BASEURL ?>/jabatan/hapusData/<?= $row['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= BASEURL ?>/jabatan/importData" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
