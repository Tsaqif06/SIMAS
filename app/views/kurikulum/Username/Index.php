                    ...
                    <div class="modal-body">
                        <form action="<?= BASEURL; ?>/Username/tambahData" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Kodeguru" name="Kodeguru" placeholder="Kodeguru" required />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Password_" name="Password_" placeholder="Password" required />
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Mata Pelajaran</label>
                                <input type="text" class="form-control" id="mapel" name="mapel" placeholder="Mata Pelajaran" required />
                            </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">Tambah Data</button>
                        <button type="button" class="btn btn-default batal" data-dismiss="modal" aria-label="Close">Tutup</button>
                    </div>
                    </form>
                </div>
            </div>
