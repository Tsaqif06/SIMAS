  ...
  .button-arounder:focus {
   ...
   <div class="row">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL; ?>/KegiatanGLS/tambah" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Strategi" name="Strategi" placeholder="Strategi"
                                required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Target_" name="Target_" placeholder="Target"
                                required />
                        </div>
                </div>
    ...
    $('.tombolTambahData').on('click', function(){
        $('formModalLabel').html('Tambah Data GLS')
