                    ...
                    <div class="row">
                      <div class="col-md-3 mb-0 stretch-card transparent">
                        <div class="card card-tale" data-toggle="modal" data-target="#modalTambah">
                          <div class="card-body"><a class="small text-white stretched-link" href="https://drive.google.com/drive/folders/1nH2tky25zaxXAAs6_ye4cv-giFAYXFWS?usp=sharing"></a>
                            <p class="mb-4">SMKN 4 MALANG</p>
                            <p class="fs-30 mb-2">Materi PIP </p>
                          </div>
                        </div> 
                      </div>
                </div>
